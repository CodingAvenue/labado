$(function () {
    ...
    function renderList(laundry_shops) {
        ...
        laundry_shops.map(function (laundry) {
            row += '<li><div class="laundry-header collapsible-header" data-target=' + laundry.place_id
                + '><i class="material-icons">local_laundry_service</i><p><span>'
    ...
    $("#laundry-list").on('click', '.laundry-header', function () {
        ...
        var container_body = $(this).next('.collapsible-body');
        $.ajax({
            url: theUrl,
        }).done(function (data) {
            ...
            container_body.html(errorMessage);
        });
    });
